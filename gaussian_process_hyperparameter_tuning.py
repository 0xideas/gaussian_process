...
def optimise_hyperparameters(Class, hyperparameters, n_iter, X, Y, n_sample=10, **kwargs):
    ...
    for i in range(n_iter):
        ...
        if np.sum(np.array(rewards[selected_arm])==0) > 1:
            ...
            categorical_hyperparameters = [hp for hp in categorical_hyperparameters if hp != failure]
